...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 mb-6 lg:mb-8">
    <div class="bg-gray-800 border border-gray-700 rounded-xl p-4 lg:p-6 shadow-xl">
        ...
        <label for="key-input-decrypt" class="block mt-4 mb-2 text-gray-200 font-semibold">Key (same length as text)</label>
        <input
            type="text"
        ...
        />
        <p class="text-xs text-gray-400 mt-2">The key must be exactly the same length as the ciphertext (excluding spaces).</p>
    </div>
...
function executeDecrypt() {
    ...
    executeCryptoAjax('one-time-pad', 'decrypt', inputField, keyField, outputField, vizContent);
}
</script>
@endpush
@endsection
