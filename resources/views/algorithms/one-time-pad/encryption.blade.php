...
@section('title', 'Encryption - One-Time Pad')
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 mb-6 lg:mb-8">
    <div class="bg-light-card dark:bg-dark-card border border-light-border dark:border-dark-border rounded-xl p-4 lg:p-6 shadow-xl">
        ...
        <label for="key-input" class="block mt-4 mb-2 text-light-text dark:text-dark-text font-semibold">Key (same length as text)</label>
        <div class="flex gap-2">
            <input
                ...
                placeholder="Enter key (must match plaintext length)"
            />
            <button
