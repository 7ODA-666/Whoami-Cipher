...
@section('title', 'Row-Column Transposition - Encryption | CipherViz')
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 mb-6 lg:mb-8">
    <div class="bg-gray-800 border border-gray-700 rounded-xl p-4 lg:p-6 shadow-xl">
        ...
        <label for="key-input" class="block mt-4 mb-2 text-gray-200 font-semibold">Keyword</label>
        <input
            type="text"
            id="key-input"
        ...
        />
        <p class="text-xs text-gray-400 mt-2">The keyword determines the column order for reading the grid.</p>
    </div>
