...
@section('title', 'Monoalphabetic Cipher - Decryption | CipherViz')
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 mb-6 lg:mb-8">
    <div class="bg-gray-800 border border-gray-700 rounded-xl p-4 lg:p-6 shadow-xl">
        ...
        <label for="key-input-decrypt" class="block mt-4 mb-2 text-gray-200 font-semibold">Substitution Key (26 letters)</label>
        <input
            type="text"
            ...
            maxlength="26"
        />
        <p class="text-xs text-gray-400 mt-2">Must be exactly 26 unique letters representing the substitution alphabet.</p>
    </div>
