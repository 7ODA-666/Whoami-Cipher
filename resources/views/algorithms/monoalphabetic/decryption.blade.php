...
@section('title', 'Decryption - Monoalphabetic Cipher')
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 mb-6 lg:mb-8">
    <div class="bg-light-card dark:bg-dark-card border border-light-border dark:border-dark-border rounded-xl p-4 lg:p-6 shadow-xl">
        ...
        <label for="key-input-decrypt" class="block mt-4 mb-2 text-light-text dark:text-dark-text font-semibold">Substitution Key (26 letters)</label>
        <input
            type="text"
            ...
            placeholder="Enter 26-letter substitution alphabet"
            maxlength="26"
        />
        <p class="text-xs text-red-500 dark:text-red-500 mt-2">Must be exactly 26 unique letters representing the substitution alphabet.</p>
    </div>
...
function executeDecrypt() {
    ...
    executeCryptoAjax('monoalphabetic', 'decrypt', inputField, keyField, outputField, vizContent);
}
</script>
@endpush
@endsection
