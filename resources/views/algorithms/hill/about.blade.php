...
<div class="bg-gray-800 border border-gray-700 rounded-xl p-6 lg:p-8 shadow-xl">
    <div class="flex items-center gap-4 mb-6">
        ...
        <h2 class="text-3xl font-bold text-gray-100">Hill Cipher</h2>
    </div>
    ...
    <div class="prose prose-invert max-w-none">
        ...
        <p class="text-gray-300 mb-4">
            <strong class="text-gray-200">Algorithm Type:</strong> Substitution Cipher (Polygraphic)
        </p>
        <p class="text-gray-300 mb-4">
        ...
        <ul class="list-disc list-inside text-gray-300 mb-6 space-y-2">
            <li><strong>Time Complexity:</strong> O(n²) for matrix multiplication, O(n) overall where n is the text length</li>
            <li><strong>Space Complexity:</strong> O(n)</li>
            <li><strong>Key Space:</strong> Depends on matrix size (2×2 or 3×3)</li>
        </ul>
    </div>
</div>
@endsection
